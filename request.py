...
with open("childern_data.json","w") as saral_data:
...
print("")
courses_name=int(input("enter your courses number that you want to learn: "))
courses_1=data["availableCourses"][courses_name-1]["name"]
parents_id=data["availableCourses"][courses_name-1]["id"]
print(courses_1)
...
if user_input_1=="p":
    ...
    while i<len(data["availableCourses"]):
        ...
        i=i+1
    user_input=int(input("enter the courses number that you want to learn: " ))
    print(data["availableCourses"][user_input-1]["name"])

parentes_api= "http://saral.navgurukul.org/api/courses/"+str(data["availableCourses"][courses_name-1]["id"])+"/exercises"
